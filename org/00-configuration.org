...
firewall_service_rules:
  ...
  - { port: "18080", proto: "tcp", comment: "Monero P2P", condition: "{{ monerod_enabled | default(false) }}" }
...
# P2Pool data directory
p2pool_data_dir: /opt/p2pool
...
# ----------------------------------------------------------------------------
# Monero Full Node Configuration (Optional)
# ----------------------------------------------------------------------------

monerod_enabled: true
monerod_out_peers: 8
monerod_in_peers: 8
monerod_limit_rate_up: 2048
monerod_limit_rate_down: 8192
monerod_rpc_bind_ip: 127.0.0.1
monerod_rpc_port: 18081
monerod_restricted_rpc: true
