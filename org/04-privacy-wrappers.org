...
ufw allow 53317/udp comment "LocalSend transfer"
ufw allow 53317/tcp comment "LocalSend transfer"

/usr/bin/localsend "$@"

ufw delete allow 53317/udp
ufw delete allow 53317/tcp
#+end_src
...
#+begin_src yaml :tangle ../ansible/fragments/04-privacy-wrappers.yml
    ...
    - name: Allow localsend wrapper to run without password prompt
      lineinfile:
        path: /etc/sudoers.d/localsend
        line: "dev ALL=(ALL) NOPASSWD: /usr/local/bin/localsend-wrapper.sh"
        create: yes
        mode: '0440'
        ...
        content: |
          {
            ...
            "kyc_profile_dir": "/home/dev/.config/chromium/kyc-identity"
          }
    ...
    - name: Display browser dispatch configuration
      debug:
        msg:
          ...
          - ""
          - "KYC domains route to: Chromium (kyc-identity profile)"
