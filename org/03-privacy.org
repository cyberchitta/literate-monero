...
Network-level privacy for operations:
- ✓ IP hidden from web services (Tor routing)
- ✓ Browser fingerprinting minimized (Tor Browser)
- ✓ P2P network privacy (I2P for Monero)
...
#+begin_src yaml :tangle ../ansible/fragments/03-privacy-infra.yml
